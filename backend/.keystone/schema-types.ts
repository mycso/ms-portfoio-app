...
export type RoleWhereInput = {
  ...
  readonly canManageReviews?: Scalars['Boolean'] | null;
  readonly canManageReviews_not?: Scalars['Boolean'] | null;
  readonly canManageShipping?: Scalars['Boolean'] | null;
  readonly canManageShipping_not?: Scalars['Boolean'] | null;
...
export type SortRolesBy =
  ...
  | 'canManageReviews_ASC'
  | 'canManageReviews_DESC'
  | 'canManageShipping_ASC'
  | 'canManageShipping_DESC'
  | 'assignedTo_ASC'
  | 'assignedTo_DESC';
...
export type RoleListTypeInfo = {
  ...
  backing: {
    ...
    readonly canManageReviews?: boolean | null;
    readonly canManageShipping?: boolean | null;
