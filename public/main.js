        ...
        files.forEach((file, i) => {
            ...
            fs.readFile(`${dirPath}/${fileName}`, "utf8", (err, contents) => {
                ...
                post = {
                    ...
                    link: metadata.link ? metadata.link : "No link given",
                    time: parsedDate["time"],
                    image: metadata.image ? metadata.image : "No image given",
                    image2: metadata.image2 ? metadata.image2 : "No image given",
                    image3: metadata.image3 ? metadata.image3 : "No image given",
                    image4: metadata.image4 ? metadata.image4 : "No image given",
